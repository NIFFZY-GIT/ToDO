...
import static niffzy.todo.R.id.*;
...
//        sppechBtn = view.findViewById(R.id.sppech_mic_btn);
//
...
//                intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE,"Speak Up");
...
//        if (requestCode == RECOGNIZER_CODE && resultCode == Activity.RESULT_OK && data != null) {
